...
import { ArrowLeft, Save, Edit, Layers, Link2 } from 'lucide-react';
            ...
            <div className="flex flex-col gap-6 p-6 w-full">
                <div className="flex items-center justify-between">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-slate-500 font-medium">Modify settings for this storefront navigation link.</p>
                    </div>
                </div>
