        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            {processing && (
                <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm">
                    ...
                    <p className="mt-4 text-sm font-black uppercase tracking-widest text-slate-900">Updating Category...</p>
                </div>
            )}
            ...
            <div className="w-full p-6">
                <div className="mb-8 flex items-center justify-between">
                    <div className="space-y-1">
                        ...
                        <h1 className="text-3xl font-black uppercase tracking-tight text-slate-950">Edit Category</h1>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="grid gap-8 lg:grid-cols-[1fr_350px]">
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        <label className="text-xs font-black uppercase tracking-widest text-slate-600">Category Name</label>
                                        <input
                                            type="text"
                                            value={data.name}
                                        ...
                                        />
                                        {errors.name && <p className="text-xs font-bold uppercase text-red-500">{errors.name}</p>}
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            rows={4}
                                            className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-sm font-bold focus:border-slate-400 focus:bg-white focus:ring-0 outline-none resize-none"
                                            placeholder="Tell us about this category..."
                                        />
                                        {errors.description && <p className="text-xs font-bold uppercase text-red-500">{errors.description}</p>}
                                    </div>
                                </div>
                            </div>

                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                <h3 className="mb-6 text-sm font-black uppercase tracking-widest text-slate-400">Category Banner</h3>
                                <div className="space-y-4">
                                    ...
                                    {errors.banner_image && <p className="text-xs font-bold uppercase text-red-500">{errors.banner_image}</p>}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                <h3 className="mb-6 text-sm font-black uppercase tracking-widest text-slate-400">Visibility</h3>
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        <label className="text-xs font-black uppercase tracking-widest text-slate-600">Show on Home</label>
