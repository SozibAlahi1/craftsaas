...
export default function CreateProduct({ categories }: CreateProps) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        gallery: [] as File[],
        description: '',
        delivery_info: 'We offer fast and reliable shipping across Bangladesh. All orders are carefully packaged to ensure your items arrive in perfect condition.',
        delivery_dhaka: '1-3 Working Days',
        delivery_outside: '3-5 Working Days',
        return_info: 'If you are not satisfied with your purchase, you can return or exchange the product within 7 days of delivery, provided it is in its original condition and packaging.',
        highlights: [''],
        color: '',
        stock_quantity: 0,
        is_in_stock: true,
        variations: {
            colors: [{ label: '', image: null as File | null }],
            sizes: [{ label: '', image: null as File | null }],
        },
        variant_matrix: [] as any[],
    });
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-slate-950 uppercase tracking-tight">Create Product</h1>
                        <p className="text-sm text-slate-500 font-medium">Add a new item to your store catalog</p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {data.image && (
                                            <div className="relative group w-full h-40 border border-slate-200 overflow-hidden mt-4 animate-in fade-in slide-in-from-top-2 duration-300">
                                                <img src={URL.createObjectURL(data.image)} alt="Primary Preview" className="h-full w-full object-cover" />
                                                <button 
                                                    type="button"
                            ...
                            >
                                ...
                                {processing ? 'Uploading & Saving...' : 'Create Product Now'}
                            </button>
                        </div>
                    </div>
                </form>
