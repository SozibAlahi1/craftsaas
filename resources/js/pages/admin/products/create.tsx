        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6">
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black tracking-tight text-slate-950 uppercase">Create Product</h1>
                        <p className="text-sm font-medium text-slate-500">Add a new item to your store catalog</p>
                    </div>
                </div>
