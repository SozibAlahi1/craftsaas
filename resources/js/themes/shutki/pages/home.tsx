    ...
    return (
        <>
            ...
            <main style={{ background: P.cream, color: P.earth }}>
                ...
                <section className="px-4 py-16 sm:px-6 lg:px-8" style={{ background: P.sageBg, borderTop: `2px solid ${P.border}` }}>
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <Link
                            ...
                            className="mt-8 inline-flex items-center gap-2 rounded-full px-8 py-3 text-sm font-black text-white shadow-md transition-all hover:-translate-y-0.5 hover:opacity-90"
