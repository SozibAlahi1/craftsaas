                            ...
                            return (
                                ...
                                >
                                    <div className="flex h-full min-h-0 flex-col">
                                        ...
                                        <div className="flex-1 flex flex-col justify-between px-2 pb-2.5 pt-2 sm:px-4 sm:pt-3 sm:pb-4">
                                            <div>
                                                <h3 className="line-clamp-2 text-xs sm:text-[1.05rem] leading-tight font-semibold text-slate-950">{product.name}</h3>
                                                <div className="mt-1 text-sm sm:text-[1.35rem] leading-none font-bold text-orange-600">{product.price}</div>

                                                <div className="mt-1 flex flex-wrap items-center gap-x-1.5 gap-y-0.5 text-[10px] sm:text-xs">
                                                    {product.old_price && <span className="text-slate-500 line-through whitespace-nowrap">{product.old_price}</span>}
                                                    {product.discount_text && (
                                                        <span className="rounded bg-orange-50 px-1.5 py-0.5 text-[9px] sm:text-[10px] sm:text-xs font-medium text-orange-600 whitespace-nowrap">
                                                            {product.discount_text}
                                                        </span>
                                                    )}
                                                </div>
                                            ...
                                            {isVariable ? (
                                                <div
                                                    className="mt-2 w-full rounded-full border text-center py-1 sm:py-2 text-[10px] sm:text-xs font-black tracking-wider uppercase transition-all duration-300"
                                                    style={{
                                                ...
                                                <div
                                                    className="mt-2 w-full rounded-full text-center py-1 sm:py-2 text-[10px] sm:text-xs font-black tracking-wider uppercase text-white shadow-sm transition-all duration-300"
                                                    style={{
