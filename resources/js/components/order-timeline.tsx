import { Clock, MessageSquare, Activity, User, Package } from 'lucide-react';
                        ...
                        {events.map((event, index) => {
                            ...
                            return (
                                <div key={index} className="relative">
                                    <div className={`absolute -left-[35px] flex h-7 w-7 items-center justify-center rounded-full border-2 border-white ${isActivity ? 'bg-blue-100 text-blue-600' : isStatus ? 'bg-emerald-100 text-emerald-600' : 'bg-amber-100 text-amber-600'}`}>
